...
/**
 * @ngdoc function
 * @name caloriecounterfitnessApp.controller:MealItemCtrl
 * @description
 * # MealItemCtrl
 * Controller of the caloriecounterfitnessApp
 */
angular.module('caloriecounterfitnessApp')
  .controller('MealItemCtrl', function ($scope, $rootScope, $filter, nutritionService, measurementService, mealItemService, mealIngredientService, usdaService) {
